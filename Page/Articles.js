...
const Articles = ({ route }) => {
    ...
    const onRefresh = useCallback(() => {
        ...
        // In a real app, you would probably fetch updated data from an API or a database
        setTimeout(() => {
          // For demonstration, we simply reverse the data array
          fetchArticles();
          getSourceName();
          setRefreshing(false);
                ...
                <FlatList
                    ...
                    refreshControl={
                        <RefreshControl
                          ...
                          onRefresh={onRefresh}
                          // You can customize the color and tintColor as needed
                          colors={['#30809b']}
                          tintColor={'#30809b'}
                        />
                      }
